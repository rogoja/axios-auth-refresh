import { AxiosInstance, AxiosPromise, AxiosResponse, InternalAxiosRequestConfig } from 'axios';
 ...
 * @return {boolean}
 */
export declare function shouldInterceptError(
 ...
 * @return {Promise<any>}
 */
export declare function createRefreshCall(
    error: any,
 ...
 * @return {number}
 */
export declare function createRequestQueueInterceptor(
    instance: AxiosInstance,
    cache: AxiosAuthRefreshCache,
    options: AxiosAuthRefreshOptions
): number;
